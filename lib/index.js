...
class NBuffer {
    ...
    #checkReadOffset(add = 0) {
        return this.readOffset + add >= this.length;
    }
    #checkWriteOffset(add = 0) {
    ...
    readInt8() {
        if (this.#checkReadOffset(NBuffer.SizeOf.Int8))
            this.#reachedEnd();
    ...
    readInt16() {
        if (this.#checkReadOffset(NBuffer.SizeOf.Int16))
            this.#reachedEnd();
    ...
    readInt32() {
        if (this.#checkReadOffset(NBuffer.SizeOf.Int32))
            this.#reachedEnd();
    ...
    readInt64() {
        if (this.#checkReadOffset(NBuffer.SizeOf.Int64))
            this.#reachedEnd();
    ...
    readFloat() {
        if (this.#checkReadOffset(NBuffer.SizeOf.Float))
            this.#reachedEnd();
    ...
    readDouble() {
        if (this.#checkReadOffset(NBuffer.SizeOf.Double))
            this.#reachedEnd();
    ...
    writeInt8(value) {
        if (this.#checkWriteOffset(NBuffer.SizeOf.Int8))
            this.#reachedEnd();
        this.writeOffset = this.#buffer.writeInt8(value, this.writeOffset);
    }
    writeInt16(value) {
        if (this.#checkWriteOffset(NBuffer.SizeOf.Int16))
            this.#reachedEnd();
    ...
    writeInt32(value) {
        if (this.#checkWriteOffset(NBuffer.SizeOf.Int32))
            this.#reachedEnd();
    ...
    writeInt64(value) {
        if (this.#checkWriteOffset(NBuffer.SizeOf.Int64))
            this.#reachedEnd();
    ...
    writeFloat(value) {
        if (this.#checkWriteOffset(NBuffer.SizeOf.Float))
            this.#reachedEnd();
    ...
    writeDouble(value) {
        if (this.#checkWriteOffset(NBuffer.SizeOf.Double))
            this.#reachedEnd();
    ...
    writeString(str, encoding) {
        if (this.#checkWriteOffset(str.length))
            this.#reachedEnd();
        this.writeOffset += this.#buffer.write(str, this.writeOffset, encoding);
    }
    write(buffer) {
        if (Buffer.isBuffer(buffer)) {
            if (this.#checkWriteOffset(buffer.length))
                this.#reachedEnd();
